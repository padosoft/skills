...
**commit integrity**, **logging discipline**, **failure visibility** and **test integrity** — the last three
are rules that three stacks that share no code arrived at independently. If you do not know which profile you need, install `core` and ask the agent.
...
_17 skills in the catalog. Section generated from the frontmatter: refresh it with `make catalog`._
