...
_36 skills across 9 profiles, grouped by what you install. A skill that belongs to two profiles appears in both. The complete list with descriptions is [at the end](#every-skill-one-by-one); `make catalog` refreshes both._

### `core` — 15 skills · installed **globally**, they apply to every project whatever the stack
...
### `laravel` — 6 skills · Laravel and PHP applications
...
### `node` — 4 skills · Node and Bun services
...
### `react-native` — 3 skills · React Native and Expo apps
...
_All 36 skills in alphabetical order: what each one says, and when it triggers. Generated from the frontmatter._
