...
_33 skills in the catalog. Section generated from the frontmatter: refresh it with `make catalog`._

| Skill | Profiles | Scope | Version |
|---|---|---|---|
| [`padosoft-atomic-invariants`](#atomic-invariants) | core | global | 0.1.0 |
| [`padosoft-contract-changes`](#contract-changes) | core | global | 0.1.0 |
| [`padosoft-docs-match-code`](#docs-match-code) | core | global | 0.1.0 |
| [`padosoft-environment-gating`](#environment-gating) | core | global | 0.1.0 |
| [`padosoft-evidence-boundaries`](#evidence-boundaries) | core | global | 0.2.0 |
| [`padosoft-failure-visibility`](#failure-visibility) | core | global | 0.2.0 |
| [`padosoft-git-commit-integrity`](#git-commit-integrity) | core | global | 0.1.0 |
| [`padosoft-logging-discipline`](#logging-discipline) | core | global | 0.2.0 |
| [`padosoft-skill-creator`](#skill-creator) | core | global | 0.2.0 |
| [`padosoft-skills-router`](#skills-router) | core | global | 0.1.0 |
| [`padosoft-tenant-isolation`](#tenant-isolation) | core | global | 0.1.0 |
| [`padosoft-test-integrity`](#test-integrity) | core | global | 0.2.0 |
| [`padosoft-verify-before-writing`](#verify-before-writing) | core | global | 0.1.0 |
| [`padosoft-admin-interface`](#admin-interface) | laravel | project | 0.1.0 |
| [`padosoft-agent-host-boundaries`](#agent-host-boundaries) | api | project | 0.1.0 |
| [`padosoft-api-security-review`](#api-security-review) | api, node | project | 0.1.0 |
| [`padosoft-ci-failure-triage`](#ci-failure-triage) | devops | project | 0.1.0 |
| [`padosoft-ci-workflow-gates`](#ci-workflow-gates) | devops | project | 0.2.0 |
| [`padosoft-cross-platform-scripting`](#cross-platform-scripting) | devops | project | 0.1.0 |
| [`padosoft-database-design`](#database-design) | data, laravel | project | 0.1.0 |
| [`padosoft-durable-effects`](#durable-effects) | api, data | project | 0.1.0 |
...
| [`padosoft-laravel-conventions`](#laravel-conventions) | laravel | project | 0.2.0 |
...
| [`padosoft-payments-reconciliation`](#payments-reconciliation) | payments | project | 0.1.0 |
| [`padosoft-pr-review-triage`](#pr-review-triage) | devops | project | 0.1.0 |
| [`padosoft-query-performance`](#query-performance) | data, laravel | project | 0.1.0 |
...
│   ├── padosoft-evidence-boundaries/   # name the claim, then name what would prove it
│   ├── padosoft-tenant-isolation/      # the scope is in the key, not in the filter
│   ├── padosoft-durable-effects/       # a queue moves work, not effects
│   ├── padosoft-payments-reconciliation/  # the equation has to close
│   ├── padosoft-agent-host-boundaries/ # what the host owns when a model is the caller
│   ├── padosoft-contract-changes/      # every dependent, found before the edit
│   ├── padosoft-verify-before-writing/ # ask, or log the doubt - never invent in silence
│   ├── padosoft-environment-gating/    # the answers are three, not two
│   ├── padosoft-database-design/       # the index is part of the design, not a later fix
│   ├── padosoft-query-performance/     # written for the volume that existed then
│   ├── padosoft-ci-failure-triage/     # the failed step is where it stopped, not why
